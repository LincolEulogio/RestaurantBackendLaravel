    ...
    <div x-data="inventoryManager()" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                <button
                    class="h-11 px-5 rounded-xl border border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-700 text-sm font-bold text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-700 shadow-sm flex items-center justify-center gap-2 transition-colors">
