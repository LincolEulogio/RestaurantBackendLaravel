                ...
                <template x-for="product in paginatedProducts" :key="product.id">
                    <div
                        ...
                        <div class="h-48 bg-gray-100 dark:bg-gray-700 relative overflow-hidden shrink-0">
                            <template
                                x-if="product.image_url && product.image_url !== 'https://placehold.co/600x400/e2e8f0/64748b?text=No+Image'">
                                <img :src="product.image_url" :alt="product.name"
                                    class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                                    x-on:error="handleImageError($event, product)">
                            </template>

                            <!-- Placeholder (Always in DOM now, but conditionally shown) -->
                            <div class="image-placeholder flex flex-col items-center justify-center h-full bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 text-gray-400 dark:text-gray-500"
                                x-show="!product.image_url || product.image_url === 'https://placehold.co/600x400/e2e8f0/64748b?text=No+Image'">
