        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                <div
                    ...
                    <span class="font-bold text-gray-700 dark:text-gray-100">{{ $pendingCount }} Pendientes</span>
                </div>
                <div
                    class="bg-white dark:bg-gray-800 px-4 py-2 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-center gap-2">
                    <span class="w-3 h-3 rounded-full bg-blue-500"></span>
                    <span class="font-bold text-gray-700 dark:text-gray-100">{{ $preparingCount }} Preparando</span>
                </div>
                <div
                    class="bg-white dark:bg-gray-800 px-4 py-2 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-center gap-2">
                    <span class="w-3 h-3 rounded-full bg-green-500"></span>
                    <span class="font-bold text-gray-700 dark:text-gray-100">{{ $readyCount }} Listos</span>
                </div>
            </div>
        </div>
            ...
            @forelse($orders as $order)
                ...
                <div
                    ...
                    @if ($order->customer_name)
                        <div
                            class="px-4 py-2 bg-gray-50 dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700">
                    ...
                    <div class="p-3 bg-gray-50 dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700">
                        ...
                        @elseif($order->status == 'ready')
                            <div class="text-center">
                                <span
                                    class="inline-flex items-center gap-2 text-green-600 font-bold text-sm dark:text-green-400">
            ...
            @empty
                ...
                <div class="col-span-full">
                    <div
                        ...
                        <svg class="w-16 h-16 mx-auto text-gray-300 dark:text-gray-400 mb-4" fill="none"
